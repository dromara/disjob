...
import static cn.ponfee.scheduler.common.date.JavaUtilDateFormat.*;
...
public class LocalDateTimeFormat {
    ...
    private static final DateTimeFormatter PATTERN_01 = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
