...
CREATE TABLE `sched_task` (
  ...
  `execute_state`       TINYINT        UNSIGNED  NOT NULL                               COMMENT '执行状态：10-等待执行；20-正在执行；30-暂停执行；40-正常完成；50-实例化失败取消；51-校验失败取消；52-初始化异常取消；53-执行失败取消；54-执行异常取消；55-执行超时取消；56-执行冲突取消(sched_job.collided_strategy=3)；57-手动取消；58-广播未执行取消；',
...
-- ----------------------------
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351000, 'default', 'noop-job',      'cn.ponfee.disjob.samples.common.handler.NoopJobHandler',          1, 1, 1, '',                                                                  1, '0/5 * * * * ?',                           unix_timestamp()*1000);
...
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351004, 'default', 'prime-count',   'cn.ponfee.disjob.samples.common.handler.PrimeCountJobHandler',    1, 1, 1, '{\"m\":1,\"n\":6000000000,\"blockSize\":100000000,\"parallel\":7}', 2, '2022-10-06 22:53:00',                     unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351005, 'default', 'broadcast-job', 'cn.ponfee.disjob.samples.common.handler.TestBroadcastJobHandler', 1, 1, 6, '',                                                                  2, '2023-03-18 21:30:00',                     unix_timestamp()*1000);
...
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351007, 'default', 'depend-job',    'cn.ponfee.disjob.samples.common.handler.PrimeCountJobHandler',    1, 1, 1, '{\"m\":1,\"n\":100000000,\"blockSize\":10000000,\"parallel\":10}',  4, '1003164910267351002,1003164910267351003', null                 );
