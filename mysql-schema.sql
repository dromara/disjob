...
-- ----------------------------
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (3988904755200, 'default', 'noop-job',      'cn.ponfee.disjob.samples.common.handler.NoopJobHandler',          1, 1, 1, '',                                                                  1, '0/5 * * * * ?',               unix_timestamp()*1000);
...
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (4236701615230, 'default', 'broadcast-job', 'cn.ponfee.disjob.samples.common.handler.TestBroadcastJobHandler', 1, 1, 6, '',                                                                  2, '2023-03-18 21:30:00',         unix_timestamp()*1000);
