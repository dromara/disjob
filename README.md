...
简体中文 | [English](https://github.com/ponfee/distributed-scheduler/blob/master/README.en.md)
...
- 支持常规的分布式任务调度功能，包括但不限于以下：
  - 自定义的线程池执行任务，复用系统资源及实现任务控制[**`WorkerThreadPool`**](https://github.com/ponfee/distributed-scheduler/blob/master/scheduler-worker/src/main/java/cn/ponfee/scheduler/worker/base/WorkerThreadPool.java)
...
4. 编写自己的任务处理器[**`PrimeCountJobHandler`**](https://github.com/ponfee/distributed-scheduler/blob/master/scheduler-samples/scheduler-samples-common/src/main/java/cn/ponfee/scheduler/samples/PrimeCountJobHandler.java)，并继承[**`JobHandler`**](https://github.com/ponfee/distributed-scheduler/blob/master/scheduler-core/src/main/java/cn/ponfee/scheduler/core/handle/JobHandler.java)类(范例中提供的是一个素数统计的处理器)
```java
