...
public class LogAspect
{
     ...
     * 忽略敏感属性
     */
    public Filter excludePropertyPreFilter(String[] excludeParamNames)
    {
        return new SimplePropertyPreFilter(ArrayUtils.addAll(EXCLUDE_PROPERTIES, excludeParamNames));
    }
