...
public class WorkerFramelessMain {
    ...
    private static WorkerRegistry createWorkerRegistry(YamlProperties config, RestTemplate restTemplate) {
        EtcdRegistryProperties registryProps = config.bind(EtcdRegistryProperties.KEY_PREFIX, EtcdRegistryProperties.class);
        return new EtcdWorkerRegistry(registryProps, restTemplate);
    }
