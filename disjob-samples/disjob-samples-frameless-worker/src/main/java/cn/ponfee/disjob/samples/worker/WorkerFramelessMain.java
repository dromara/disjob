...
public class WorkerFramelessMain {
    ...
    private static WorkerRegistry createWorkerRegistry(YamlProperties config, RestTemplate restTemplate) {
        ConsulRegistryProperties registryProps = config.bind(ConsulRegistryProperties.KEY_PREFIX, ConsulRegistryProperties.class);
        return new ConsulWorkerRegistry(registryProps, restTemplate);
    }
