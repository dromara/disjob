...
-- ----------------------------
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (3988904755200, 'default', 'noop-job',    'cn.ponfee.scheduler.core.handle.impl.NoopJobHandler',             1, '',                                                                    1, '0/30 * * * * ?',      unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (3988904755300, 'default', 'http-job',    'cn.ponfee.scheduler.core.handle.impl.HttpJobHandler',             1, '{"method":"GET", "url":"https://www.baidu.com"}',                     1, '0/10 * * * * ?',      unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (3988904755400, 'default', 'command-job', 'cn.ponfee.scheduler.core.handle.impl.CommandJobHandler',          1, '{"cmdarray":["/bin/sh","-c","echo $(date +%Y/%m/%d)"]}',              1, '0/15 * * * * ?',      unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (3988904755500, 'default', 'script-job',  'cn.ponfee.scheduler.core.handle.impl.ScriptJobHandler',           1, '{"type":"SHELL","script":"#!/bin/sh\\necho \\"hello, shell!\\"\\n"}', 1, '0/10 * * * * ?',      unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (4236701614080, 'default', 'prime-count', 'cn.ponfee.scheduler.samples.common.handler.PrimeCountJobHandler', 1, '{\"m\":1,\"n\":6000000000,\"blockSize\":100000000,\"parallel\":7}',   2, '2022-10-06 22:53:00', unix_timestamp()*1000);
