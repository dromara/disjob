...
class VersionUtilsTest {
    ...
    @Test
    void testGetVersion() {
        Assertions.assertEquals("3.20.0", VersionUtils.getVersion(StringUtils.class));
        Assertions.assertEquals("33.6.0-jre", VersionUtils.getVersion(Graph.class, "com.google.guava", "guava"));
