...
public class RedisLock implements Lock, java.io.Serializable {
    ...
    private boolean acquire() {
        ...
        Long ret = RedisTemplateUtils.evalScript(redisTemplate, LOCK_SCRIPT, 1, keysAndArgs);
    ...
    private boolean release() {
        ...
        Long ret = RedisTemplateUtils.evalScript(redisTemplate, UNLOCK_SCRIPT, 1, keysAndArgs);
