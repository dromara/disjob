...
@Configuration
@MapperScan(
    basePackages = JobDataSourceConfig.BASE_PACKAGE + ".mapper",
    sqlSessionTemplateRef = JobDataSourceConfig.DB_NAME + SQL_SESSION_TEMPLATE_SUFFIX
)
public class JobDataSourceConfig extends AbstractDataSourceConfig {
