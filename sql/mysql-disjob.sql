...
INSERT INTO `sched_job` (`job_id`, `group`, `job_name`, `job_executor`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351007, 'app-test', 'depend-job',    'cn.ponfee.disjob.test.executor.PrimeCountJobExecutor',               1, 1, 1, '{\"m\":1,\"n\":50000000,\"blockSize\":2000000,\"parallel\":2}',  6, '1003164910267351000,1003164910267351001', null                 );
INSERT INTO `sched_job` (`job_id`, `group`, `job_name`, `job_executor`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351020, 'app-test', 'fixed-rate',    'cn.ponfee.disjob.test.executor.NoopJobExecutor',                     1, 1, 1, 'fixed-rate demo',                                                4, '20',                                      unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `group`, `job_name`, `job_executor`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351021, 'app-test', 'fixed-delay',   'cn.ponfee.disjob.test.executor.NoopJobExecutor',                     1, 1, 5, 'fixed-delay demo',                                               5, '20',                                      unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `group`, `job_name`, `job_executor`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351008, 'app-test', 'workflow-json-graph', '[{"source":"1:1:AJobExecutor","target":"1:1:CJobExecutor"},{"source":"1:1:AJobExecutor","target":"1:1:DJobExecutor"},{"source":"1:1:BJobExecutor","target":"1:1:DJobExecutor"},{"source":"1:1:BJobExecutor","target":"1:1:EJobExecutor"}]', 1, 2, 2, '', 2, '2023-03-18 21:30:00', unix_timestamp()*1000);
