...
CREATE TABLE `sched_job` (
  ...
  `trigger_value`       VARCHAR(255)             NOT NULL                               COMMENT '触发器配置(对应trigger_type)：1-Cron表达式；2-时间格式(2000-01-01 00:00:00)；3-{"period":"DAILY","start":"2018-12-06 00:00:00","step":1}；4-毫秒数；5-毫秒数；6-父任务job_id(多个逗号分隔)；',
