...
CREATE TABLE `sched_task` (
  ...
  `execute_state`       TINYINT        UNSIGNED  NOT NULL                               COMMENT '执行状态：10-等待执行；20-正在执行；30-暂停执行；40-正常完成；50-实例化异常；51-校验失败；52-初始化异常；53-执行失败；54-执行异常；55-执行超时；56-执行冲突(sched_job.collided_strategy=3)；57-手动取消；58-广播未执行；',
  `execute_snapshot`    TEXT                               DEFAULT NULL                 COMMENT '保存的执行快照(状态)数据',
...
-- ----------------------------
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351000, 'default', 'noop-job',      'cn.ponfee.disjob.test.handler.NoopJobHandler',                  1, 1, 1, '',                                                                  1, '0/5 * * * * ?',                           unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351001, 'default', 'http-job',      'cn.ponfee.disjob.core.handle.impl.HttpJobHandler',              1, 1, 1, '{"method":"GET", "url":"https://www.baidu.com"}',                   1, '0/10 * * * * ?',                          unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351002, 'default', 'command-job',   'cn.ponfee.disjob.core.handle.impl.CommandJobHandler',           1, 1, 1, '{"cmdarray":["/bin/sh","-c","echo $(date +%Y/%m/%d)"]}',            1, '0/15 * * * * ?',                          unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351003, 'default', 'script-job',    'cn.ponfee.disjob.core.handle.impl.ScriptJobHandler',            1, 1, 1, '{"type":"SHELL","script":"#!/bin/sh\\necho \\\"hello shell!\\\""}', 1, '0/30 * * * * ?',                          unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351004, 'default', 'prime-count',   'cn.ponfee.disjob.test.handler.PrimeCountJobHandler',            1, 1, 1, '{\"m\":1,\"n\":6000000000,\"blockSize\":100000000,\"parallel\":7}', 2, '2022-10-06 22:53:00',                     unix_timestamp()*1000);
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351005, 'default', 'broadcast-job', 'cn.ponfee.disjob.test.handler.TestBroadcastJobHandler',         1, 1, 6, '',                                                                  2, '2023-03-18 21:30:00',                     unix_timestamp()*1000);
...
INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `route_strategy`, `job_param`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351007, 'default', 'depend-job',    'cn.ponfee.disjob.test.handler.PrimeCountJobHandler',            1, 1, 1, '{\"m\":1,\"n\":100000000,\"blockSize\":10000000,\"parallel\":10}',  4, '1003164910267351002,1003164910267351003', null                 );

INSERT INTO `sched_job` (`job_id`, `job_group`, `job_name`, `job_handler`, `job_state`, `job_type`, `trigger_type`, `trigger_value`, `next_trigger_time`) VALUES (1003164910267351008, 'default', 'workflow-json-graph', '[{"source":"1:1:AJobHandler","target":"1:1:CJobHandler"},{"source":"1:1:AJobHandler","target":"1:1:DJobHandler"},{"source":"1:1:BJobHandler","target":"1:1:DJobHandler"},{"source":"1:1:BJobHandler","target":"1:1:EJobHandler"}]', 1, 2, 2, '2023-03-18 21:30:00', unix_timestamp()*1000);

-- depend job config
INSERT INTO `sched_depend` (`child_job_id`, `parent_job_id`, `sequence`) VALUES (1003164910267351007, 1003164910267351002, 1);
INSERT INTO `sched_depend` (`child_job_id`, `parent_job_id`, `sequence`) VALUES (1003164910267351007, 1003164910267351003, 2);
